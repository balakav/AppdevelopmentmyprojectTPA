...
class Customer implements v{
    ...
    public Customer(String name, String email, String phoneNo, String fromAddress, String toAddress, String date,
                    String deliveryStatus, String itemType, int itemWeight, String paymentType, int amount) {
        this.name = name;
        this.email = email;
...
class OldCustomer extends Customer {
    ...
    public OldCustomer(int customerId, String fromAddress, String toAddress, String date, String deliveryStatus,
                       String itemType, int itemWeight, String paymentType, int amount) {
        super("", "", "", fromAddress, toAddress, date, deliveryStatus, itemType, itemWeight, paymentType, amount);
