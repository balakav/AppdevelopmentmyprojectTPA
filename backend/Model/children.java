...
public class children {
	...
	public children(int chid, String email, String fname, String lname, String address, String address2, String city,
			String state1, String country, String phoneno, Date adate, String atime, int noa, int nok, String dyhasr) {
		super();
		this.chid = chid;
		this.email = email;
		this.fname = fname;
