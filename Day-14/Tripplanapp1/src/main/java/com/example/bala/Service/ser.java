...
//    private fkrepo fk1;
    ...
    public List<bus> getAllbususers() {
        return b.findAll();
    }
...
//    }
    ...
    //put for 14 tables;
    public model regform(String email, model m) {
...
//    public bus busupdate(String email, bus m) {
//    	bus bobj = studentRepository.findById(email).get();
//        bobj.setName(m.getName());
//        bobj.setEmail(m.getEmail());
//        bobj.setPassword(m.getPassword());
//        bobj.setConfirmpassword(m.getConfirmpassword());
//      return studentRepository.save(stu);
//    }
//    public model regform(String email, model m) {
//    	model stu = studentRepository.findById(email).get();
