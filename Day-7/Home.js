...
const [swiperRef, setSwiperRef] = useState(null);
  return (
   ...
   <Link to="/Home"><HomeIcon sx={{ fontSize: 35,color:"black"}}className='just'></HomeIcon></Link>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   <Link to="/Hotelform"><HotelIcon  sx={{ fontSize:  35 ,color:"black"  }} className='just'></HotelIcon></Link>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   <Link to="/Categery"><CategoryIcon  sx={{ fontSize: 35 ,color:"black" }} className='just'></CategoryIcon></Link>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   <Link to="/Currentoffer"><LocalOfferIcon sx={{ fontSize: 35,color:"black"  }} className='just'></LocalOfferIcon></Link>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   <PlaceIcon sx={{ fontSize: 35,color:"black"  }} className='just'></PlaceIcon>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   < HelpCenterIcon sx={{ fontSize: 35,color:"black"  }} className='just'></HelpCenterIcon>
   ...
   <h1>THE FAMOUS PLACE OF THE WORLD</h1>
   <Swiper
  ...
  <br></br><br></br><br></br><br></br><br></br><br></br>
      <h1>THE FAMOUS TEMPLE OF THE WORLD</h1>
      <Swiper
        onSwiper={setSwiperRef}
        slidesPerView={3}
        centeredSlides={true}
