...
handleDyhasrChange=(event)=>{
  ...
  render(){
    return (
     ...
     <input type="date" className='iname' value={this.state.ddate} onChange={this.handleDdateChange}></input>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='time' className='iname3' value={this.state.dtime} onChange={this.handleDtimeChange}></input>
     ...
     <textarea id="w3review" name="w3review" rows="4" cols="50" placeholder='Type here....' value={this.state.dyhasr} onChange={this.handleDuhasrChange}>
