...
public class Hotel {
	...
	public Hotel(String email, String hotelname, String fname, String lname, String address, String address2,
			String city, String state1, String country, String phoneno, Date adate, Time atime, Date ddate, Time dtime,
			int noa, int nok, String dyhasr) {
		super();
		this.email = email;
		this.hotelname = hotelname;
		this.fname = fname;
