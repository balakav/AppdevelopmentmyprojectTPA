...
public class covai {
	...
	public covai(int coid,String email, String fname, String lname, String address, String address2, String city, String state1,
			String country, String phoneno, Date adate, Time atime, int noa, int nok, String dyhasr) {
		super();
		this.coid=coid;
		this.email = email;
		this.fname = fname;
